...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 left-0 z-50 w-full py-1 bg-white shadow-sm dark:bg-black">
      <div className="container max-w-4xl mx-auto">
        <div className="relative flex items-center justify-between h-20">
          <div className="flex items-center flex-1 sm:items-stretch sm:justify-between">
            <Link href="/" className="mx-auto md:m-0 md:animate-pulse">
              <div className="py-0 ">
                <Image
    ...
    <div className="items-center justify-end hidden sm:flex">
      <div className="flex items-center space-x-4">
        {navbarLinks.map((link) => (
          <Link href={link.href} className="duration-200 hover:scale-105">
        ...
        {user ? (
          ...
          <Link href="/login" className="duration-200 hover:scale-110">
...
const Account = () => {
  ...
  return (
    <div className="flex">
      ...
      <button
        className="ml-2 text-sm font-bold text-white font-nerd"
        onClick={() => logout()}
      >
